...
orangeLower = np.array([0, 0, 0])  # [0, 129, 100])
orangeUpper = np.array([180, 255, 30])  # [180, 255, 255])
...
while True:
    ...
    frame_copy = cv2.rectangle(frame_copy, (0, height//2 - windowSize//2),
                               (width, height//2 + windowSize//2), (255, 0, 0), 2)
